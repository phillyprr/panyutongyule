...
var config = {
  ...
  colors: ['#00C4E2', '#FF4E00', '#363547', '#F3F3F3', '#f15c80', '#8085e9'],
...
function drawRadarDataPoints(series, opts, config, context) {
  ...
  for (var i = config.radarGridCount; i >= 0; i--) {
    if (i === 0 || i === 1) {
      context.setStrokeStyle('#D4D3DD');
      context.setFillStyle('#D4D3DD');
      context.fill();
    } else if (i === 2) {
      context.setStrokeStyle('#EAE9EF');
      context.setFillStyle('#EAE9EF');
      context.fill();
    } else if (i === 3) {
      context.setStrokeStyle('#F9F9FB');
      context.setFillStyle('#F9F9FB');
      context.fill();
    } else if (i === 4) {
      context.setStrokeStyle('#F9F9FB');
      context.setFillStyle('#F9F9FB');
